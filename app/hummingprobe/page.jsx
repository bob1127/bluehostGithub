...
export default async function Home() {
  ...
  const ProductPost = {
    ...
    description:
      "超極生技UltraE以專利技術開發的的免校正蜂鳥探針pH meter 酸鹼度計。具有拋棄式的電極設計，微升級的樣品需求量，以IS9001的高規格生產提供您高精準度的測試結果適合珍貴及特殊樣品，可以突破傳統pH測量儀的眾多限制。更可客製化訂製此微型pH檢測感測元件，將其嵌入新的產品(OEM/ODM)",
    image:
      "https://www.ultraehp.com/images/Products-Detail-Img/UH-1/UX200.webp",
    positive01: "7.0”彩色觸控屏幕",
    positive02: "演算法自動終點判斷",
    positive03: "防水防塵等級",
    LogoImg:
      "https://www.ultraehp.com/images/Products-Detail-Img/UP100/company-logo.webp",
  ...
  return (
    <div className="dark:bg-black bg-gray-100">
      ...
      <link
        rel="alternate"
        href="https://www.ultraehp.com/hummingprobe/en/"
        hreflang="en"
      />

      <meta
        name="keywords"
        content="蜂鳥探針｜水質檢測、土壤檢測、pH感測器、pH測量儀、pH meter、酸鹼度計、pH檢測器、pH值檢測計、可攜式 pH計、桌上型pH計、pH測量儀 、pH電極、酸鹼度計、酸鹼測試、pH測試"
      />
      <meta
        key="description"
        name="description"
        content="超極生技UltraE以專利技術開發的的免校正蜂鳥探針pH meter 酸鹼度計。具有拋棄式的電極設計，微升級的樣品需求量，以IS9001的高規格生產提供您高精準度的測試結果適合珍貴及特殊樣品，可以突破傳統pH測量儀的眾多限制。更可客製化訂製此微型pH檢測感測元件，將其嵌入新的產品(OEM/ODM)."
      />
      <meta name="viewport" content="width=device-width, initial-scale=1.0" />
      <link
        rel="icon"
        href="https://www.ultraehp.com/ultra-logo.ico"
        type="image/ico"
      ></link>
      ...
      <meta
        property="og:url"
        content="https://ithelp.ithome.com.tw/articles/10278469"
      />
...
"
      ...
      <section className="section_HeroVideo relative"></section>
      ...
      <section className="section_whate section ">
        <div className="container">
          <div className="row">
            <h2 className="text-center leading-normal mx-auto w-full  md:w-1/2">
              什麼是蜂鳥探針?
            </h2>
          </div>
              ...
              <div className="">
                <Card className="py-4">
                  <CardHeader className="pb-0 pt-2 px-[40px] flex-col overflow-y-scroll  items-start">
                    ...
                    <ReadMoreReact
                      text="玻璃電極的損耗，常來自於玻璃膜孔洞的堵塞，或者因清洗造成表面磨損。蜂鳥探針的拋棄式設計，特別適用於會和內參比液反應的蛋白質樣品，很難清潔的粘稠樣品，以及需要戶外長途攜帶的需求。
"
                      min={20}
                      ideal={35}
                      duration={500}
              ...
              <div>
                <Card className="py-4">
                  <CardHeader className="pb-0 pt-2 px-[40px] flex-col overflow-y-scroll  items-start">
                    ...
                    <ReadMoreReact
                      text="傳統的酸鹼度計玻璃薄膜使用後，薄膜表面可交換氫離子含量發生變化(阻塞，磨損)，以及內部溶液氫離子濃度改變(內參考液濃度及壓力改變)，進而產生誤差，因此玻璃電極在精確測量前皆須進行校正後才能使用。蜂鳥探針的每一片試片都已經為您預先校正完畢，讓您即開即用。
              ...
              <div>
                <Card className="py-4">
                  <CardHeader className="pb-0 pt-2 px-[40px] flex-col overflow-y-scroll  items-start">
                    ...
                    <ReadMoreReact
                      text="溫度補償的原因是因為不同溫度時，同一個pH的液體會因為解離常數改變造成pH讀值改變，所以透過溫度補償的模式把不同溫度校正回25度的pH值。蜂鳥探針每一片都有獨立的溫度感應元件，精確測定樣品溫度，並做智慧型數據補償，精準顯示樣品pH值。
"
                      min={20}
                      ideal={35}
                      duration={500}
              ...
              <div>
                <Card className="py-4">
                  <CardHeader className="pb-0 pt-2 px-[40px] flex-col overflow-y-scroll  items-start">
                    ...
                    <ReadMoreReact
                      text="蜂鳥探針酸鹼檢測試片(pH計)，使用專利的氫離子吸附膜設計以此替代傳統pH玻璃電極內參考電極的設計。因此，沒有填充液，不需保養，也無需保存於保存液體中。
...
"
              ...
              <div>
                <Card className="py-4">
                  <CardHeader className="pb-0 pt-2 px-[40px] flex-col overflow-y-scroll items-start">
                    <h4 className="font-bold text-large">國際認證</h4>
                    <ReadMoreReact
                      text="通過ISO 9001：2015品質管理系統國際驗證並取得證書。全面性的品質控制、設備自動化的生產、嚴謹的生產流程管制，確保每一次的檢測的精準。
              ...
              <div>
                <Card className="py-4">
                  <CardHeader className="pb-0 pt-2 px-[40px] flex-col overflow-y-scroll  items-start">
                    ...
                    <ReadMoreReact
                      text="生物樣品例如血液，唾液，腦髓液，組織液等都無法大量採樣。因此蜂鳥探針的將電極尺寸降低至1 mm，樣品需求量更是可小到1微升(μL)。對於使用極微量樣品之情境有很大的幫助，特別是細胞工程、基因工程及生命科學領域，量測準確度在±0.1，解析度在±0.01，足以符合市場上大部分的量測需求。
      ...
      <section className="section_toolip section px-0 md:px-20 flex  flex-col justify-center items-center">
        <div className="wrap  flex flex-col  md:flex-row px-[20px] md:px-[60px] mb-[35px] md:mb-[80px] 2xl:px-[150px]  bg-slate-100   rounded-3xl w-full md:w-[70%] py-[100px]">
          ...
          <div className="txt w-full md:w-1/2 flex flex-col justify-center items-center">
            <h4 className="text-[32px] font-bold">快來跟我們聊聊吧!</h4>
            <p className="text-center w-3/4">
              如果還不確定是否適用 立即聯絡專人體驗我們的產品
            </p>

            <a
              href="https://www.ultraehp.com/ContactUs.html"
              className="bg-orange-500 mt-4 px-5 py-1 text-white rounded-full"
            >
              聯絡我們
            </a>
