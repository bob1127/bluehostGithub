...
const ProductPost = {
    ...
    description: "創新的免校正免收集拋棄式pH酸鹼檢測電極/蜂鳥探針Humming Probe UH2-Gas具有無需預先收集氣體，無需使用校正液校正，打開即用的拋棄式設計。免收集氣體直接測試pH的設計適合連續氣體酸鹼值的偵測。酸鹼測試電極",
...
//     image: "https://www.ultraehp.com/images/Products-Detail-Img/UH2-Gas/UH2-GAS-%E6%B0%A3%E9%AB%94%E5%9C%96.webp?w=828?p=undefined",
//     positive01: "即開即用，精準免校正",
//     positive02: "適用於氣體樣品",
//     positive03: "拋棄式電極無交叉汙染",
...
const Product = props => (
    ...
    <div className="relative">
        ...
        {/* 結構化資料  */}
        <title>蜂鳥探針-UH2-Gas｜免校正免收集拋棄式氣體pH酸鹼檢測電極｜Humming Probe｜超極生技UltraE
        </title>
           ...
           <div className="fixed mobile-lang w-full top-[10px] pr-6 md:hidden flex justify-end mx-auto z-[99999] ">
            ...
            <div className="langDropdown w-[10px]  text-right ml-[87.5vw]  top-[15px] fixed z-[999]">
                ...
                <Dropdown>
                    <DropdownTrigger>
                        ...
                        >
                            <Image className='mb-3 pr-20 ' src='earth.png' loader={myLoader09} loading='lazy' placeholder='empty' alt='language-switch' width={33} height={33} />
                        </Button>
                    </DropdownTrigger>
                    <DropdownMenu aria-label="Static Actions">
                        <DropdownItem key="new">
                            <a className="block w-full" href="https://www.ultraehp.com/hummingprobe/en/UH2-GAS.html">English</a>
                        </DropdownItem>
                        <DropdownItem key="new">
                            <a className="block w-full" href="https://www.ultraehp.com/hummingprobe/UH2-GAS.html">繁體中文</a>
                        </DropdownItem>
            ...
            <div className='fullscreen relative pt-[60px]'>
                ...
                <section className="section   mt-0 md:mt-[150px]">
                    <div className="Navgation mb-[30px] hidden md:block pl-[150px]"> <a href="https://ultraehp.com/" className="hover:font-bold">Home</a> / <a className="hover: font-bold " href='# '>Humming Probe UH2-Gas
                        免收集氣體酸鹼電極</a> </div>
                    ...
                    <div className="container w-full flex px-[0px] md:px-[20px] xl:px-[70px] flex-col md:flex-row justify-start items-start">
                        ...
                        <div className="right flex justify-center  md:justify-between md:pl-[50px] xl:pl-[80px] w-full md:w-1/2 flex-col  h-[480px]">
                            <div className="txt">
                                <h1 className="h1-u">Humming Probe UH2-Gas<br/>
                                    免收集氣體酸鹼電極</h1>
                                <h3 className="model-u">酸鹼試紙/酸鹼檢測/pH試片電極/pH電極/pH試紙

                                </h3>
                                <p className="text-middle-u">業界首創氣體pH量測方法，利用特殊氣體交換薄膜，結合試片電極微小的特性，能夠快速簡便的測量氣體pH，為全球首創專業測量技術和創新的解決方案。
...
{/* 
            ...
            <div className="content-bottom">
                ...
                {/* <section className="section_video01 px-0 mx-0 section   flex justify-center">
                    ...
                    <div className="container  w-full md:w-4/5 lg:w-2/3  ">
                        <div className="row mb-5">
                            ...
                            <h2 className="text-[32px]">操作影片</h2>
                ...
                <section className="section">
                    <div className="row">
                        <h2 className=" w-2/3 md:w-1/2 mx-auto text-[32px] text-center ">獨創免收集氣體pH酸鹼檢測試片是如何運作的
</h2>
                    </div>
                    <div className="pb-[50px] operation mt-3 px-0 md:px-[70px] lg:px-[90px] xl:px-[150px] 2xl:px-[300px]  w-full flex flex-col md:flex-row  ">
                        ...
                        <div className="left mr-3 flex flex-col overflow-hidden rounded-2xl w-full md:w-1/2">
                            <div className="wrap bg-[#f0f1f7]  shadow-xl ">
                                ...
                                <div className="txt flex flex-col justify-center    p-[40px]">
                                    <b className="text-[18px] font-extrabold">專利多孔氣體交換水凝膜設計</b>
                                    <p className="text-orange-500 font-bold">氣體樣品無需預處理即可檢測</p>
                                    <p className="text-[14px]">傳統pH量測屬於溶液相系統，但如果要測試揮發飄散至空氣中的揮發性酸鹼物質，通常會先收集這些揮發出來的酸鹼物質並且將其製成溶液後再進行pH的量測。專利的納米孔洞水凝膜，會藉由水凝膜交換氣體後，在電極表面進行水解後可以直接檢測揮發性酸鹼氣體的pH值</p>
                                </div>
                        ...
                        <div className="right mt-4 lg:mt-0 flex flex-col justify-center items-center bg-[#f0f1f7] rounded-2xl w-full md:w-1/2">
                            ...
                            <div className="txt flex flex-col justify-center    p-[40px]">
                                <b className="text-[18px] font-extrabold">專利氫離子吸附膜設計
</b>
                                <p className="text-orange-500 font-bold">精確維持表面可交換氫離子的含量
</p>
                                <p className="text-[14px]">使用專利的氫離子吸附膜，除了可以選擇性讓樣品中氫離子通過，避免樣品中其他雜質吸附電極表面造成的鈍化，簡化樣品處理步驟。更可以通過氫離子吸附膜的設計精確控制能斯特方程式中會影響Ek’數值的表面可交換氫離子含量。
                ...
                <section className="section_four m-[20px] md:m-10 ">
                    <div className="row grid  grid-cols-2 gap-3  mx-auto 2xl:w-[900px] xl:w-[600px] md:w-[500px] w-full md:grid-cols-4">
                        <div className="flex p-2 md:p-0 flex-col justify-center items-center">
                            <Image alt='免校正免收集拋棄式氣體pH酸鹼檢測電極/蜂鳥探針可應用於新鮮度，魚肉氨類或氮類物質酸鹼檢測/Humming Probe UH2-Gas/超極生技UltraE' src='UH2gas-07-新鮮度檢測1000x1000.webp' loading="lazy" loader={myLoader08} width={190} className="rounded-xl mx-3" height={190}></Image>
                            <span className="mt-2" alt='新鮮度檢測-UltraE'>新鮮度檢測</span>
                        </div>
                        <div className="flex p-2 md:p-0 flex-col justify-center items-center">
                            <Image src='UH2gas-08-廢氣排放檢測1000x1000.webp' loading="lazy" alt='免校正免收集拋棄式氣體pH酸鹼檢測電極/蜂鳥探針可應用廢氣(二氧化硫，二氧化氮）排放酸鹼檢測/Humming Probe UH2-Gas/超極生技UltraE     ' loader={myLoader08} width={190} className="rounded-xl mx-3" height={190}></Image>
                            <span className="mt-2" alt='廢棄排放檢測-UltraE'>廢棄排放檢測</span>
                        </div>
                        <div className="flex p-2 md:p-0 flex-col justify-center items-center">
                            <Image src='UH2gas-09-發酵過程監測1000x1000.webp' loading="lazy" loader={myLoader08} width={190} className="rounded-xl mx-3" alt='免校正免收集拋棄式氣體pH酸鹼檢測電極/蜂鳥探針可應用發酵和熟成過程的酸鹼檢測/Humming Probe UH2-Gas/超極生技UltraE              ' height={190}></Image>
                            <span className="mt-2">發酵過程監測</span>
                        </div>
                        <div className="flex p-2 md:p-0 flex-col justify-center items-center">
                            <Image src='UH2gas-06-連續氣體檢測1000x1000.webp' loading="lazy" loader={myLoader08} width={190} className="rounded-xl mx-3" alt='免校正免收集拋棄式氣體pH酸鹼檢測電極/蜂鳥探針應用於連續排放氣體的檢測或監測/Humming Probe UH2-Gas/超極生技UltraE' height={190}></Image>
...
" />
                ...
                <section className="section_special px-[20px] md:px-0">
                    <h2 className="h2-u ">蜂鳥探針pH檢測電極<br/>UH2-GAS除了免校正外還有什麼特別之處？
</h2>
                    <div className="card-wrap justify-center flex flex-wrap ">
                        <div className="card h-full shadow-xl  md:m-3 overflow-hidden border rounded-2xl w-full md:w-[340px] p-6">
                            <div className="txt">
                                <b className="text-[18px] text-center font-black">拋棄式設計


                                </b>
                                <ReadMoreReact text="每一次使用只需從密封罐內取出全新的試片，且在測試後無需費時清洗保養。對於粘稠或容易吸附的樣品或配合各種特殊處理，突破傳統pH玻璃電極種種限制，提供您更多的應用。
"
                                    min={10}
                                    ideal={25}
                                    duration={500}
                        ...
                        <div className="card h-full shadow-xl md:m-3 overflow-hidden border rounded-2xl w-full md:w-[340px] p-6">
                            <div className="txt ">
                                <b className="text-[18px] text-center font-black">纖細的檢測電極設計


                                </b>
                                <ReadMoreReact text="纖細的電極設計，方便置入狹小管道，取樣口，或插入生物體內。
"
                                    min={20}
                                    ideal={35}
                                    duration={500}
                            ...
                            <div className="img">
                                <Image width={400} alt='纖細電極設計' className="rounded-2xl mt-3" height={400} src='UH2gas-04-纖細電極設計720x540.webp' placeholder="empty" loading='lazy' loader={myLoader08}></Image>
                            </div>
                        </div>
                        <div className="card  h-full shadow-xl md:m-3 overflow-hidden border rounded-2xl  w-full md:w-[340px] p-6">
                            <div className="txt ">
                            ...
                            > About Helicobacter pylori</motion.h2>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <h2 className="h2-u">UH2-Gas 酸鹼試片電極
                                    ...
                                    >
                                        ...
                                        <a href='https://www.ultraehp.com/images/DM/UH2-GAS單張DM-v1-OUT.jpeg' download='https://www.ultraehp.com/images/DM/UH2-GAS單張DM-v1-OUT.jpeg' className="rounded-full text-center w-[150px] font-black bg-orange-500 text-white py-2 px-4 mx-auto mb-[50px]">
                                            DM 下載
                                        </a>
                                        {/* 
                                    ...
                                    >
                                        ...
                                        <div className="grid grid-cols-1 lg:grid-cols-2">
                                            <div className="p-0 xl:p-10 items-end flex flex-col">
                                                ...
                                                <Image loader={myLoader08} src='尺寸-UH2-GAS.webp' loading='lazy' placeholder="empty" className="mr-[100px] w-full" alt='UX100_酸鹼檢測器-尺寸圖' width={600} height={600}></Image>
