...
const ProductPost = {
  ...
  description:
    "連續檢測趨勢免校正微量拋棄式pH計酸鹼檢測儀UX200搭配拋棄式電極只需超低樣品需求量，並且無需pH標準液校正即可完成酸鹼測試 ，並且提供連續酸鹼檢測趨勢顯示，適合非常珍貴樣品及易污染或鈍化pH電極表面和特殊樣品。可應用於尾氣廢氣連續檢測，實驗條件控制，酸鹼滴定。觸控熒幕，直覺操作，且適合戶外無電源使用。",
  image: "https://www.ultraehp.com/images/nav/UX200.webp",
...
const Product = (props) => (
  <div className="relative">
    ...
    <link
      rel="alternate"
      href="https://www.ultraehp.com/hummingprobe/en/UX200.html"
      hreflang="en"
    />

    {/* metadata */}
    <title>
      蜂鳥探針-UX200｜連續檢測趨勢免校正微量拋棄式酸鹼度檢測儀｜Humming
      Probe｜超極生技UltraE
    </title>
    <meta
      key="description"
      name="description"
      content="連續檢測趨勢免校正微量拋棄式pH計酸鹼檢測儀UX200搭配拋棄式電極只需超低樣品需求量，並且無需pH標準液校正即可完成酸鹼測試 ，並且提供連續酸鹼檢測趨勢顯示，適合非常珍貴樣品及易污染或鈍化pH電極表面和特殊樣品。可應用於尾氣廢氣連續檢測，實驗條件控制，酸鹼滴定。觸控熒幕，直覺操作，且適合戶外無電源使用。"
    />
    <meta
      name="keywords"
    ...
    <meta
      property="og:url"
      content="https://www.ultraehp.com/hummingprobe/UX200.html"
    />
    <meta property="og:type" content="website" />
    <meta
      property="og:title"
      content="蜂鳥探針-UX200｜連續檢測趨勢免校正微量拋棄式酸鹼度檢測儀｜Humming Probe｜超極生技UltraE"
    />
    <meta
    ...
    <meta
      property="og:image"
      content="https://www.ultraehp.com/images/Products-Detail-Img/UX200/UX200.png"
    />
    ...
    >
      ...
      <div className="fullscreen relative pt-0  md:pt-[60px]">
        ...
        <section className="section   mt-0 md:mt-[150px]">
          <div className="Navgation mb-[30px] hidden md:block mt-[100px] pl-0 lg:pl-[150px]">
            {" "}
          ...
          <div className="container w-full flex px-[0px] md:px-[20px] xl:px-[70px] flex-col md:flex-row justify-start items-start">
            ...
            <div className="right flex justify-center  md:justify-between   w-full md:w-1/2 flex-col md:pl-[50px] xl:pl-[80px] h-[480px]">
              <div className="txt ">
                <h1 className="h1-u">
                  Humming Probe UX200<br></br>
                  免校正酸鹼檢測儀
                </h1>
                <h3 className="model-u">pH計/酸鹼度測定計/pH儀器</h3>
      ...
      <div className="content-bottom ">
        <section
          className="section_Accessories px-[20px] sm:px-[70px] xl:px-[200px]"
          id="inside"
        >
          ...
          <div className="row mx-auto w-full xl:w-[1000px]">
            <Image
              ...
              placeholder="empty"
            ></Image>
            <b className="text-[26px] mt-[24px] font-extrabold">
              What's Include ?
            </b>
            <ul>
              <li>1.UX200:酸鹼檢測儀(一台)</li>
              ...
              <li>
                7.詳細說明書，儲存於酸鹼檢測儀UX200記憶體內，可傳輸至電腦觀看
              </li>
            </ul>
          </div>
        </section>
        <section className="section_Accessories" id="inside">
          <div className="flex flex-col w-full lg:px-[60px]  xl:px-[200px] bg-gray-150">
            <div className="w-full text-center mb-3 flex  items-center justify-center flex-col ">
              ...
              <p className="">Product Appearance</p>
            </div>
            <div className="row">
              <Image
                src="UX200-12-產品說明-720x540_工作區域 1-3.webp"
                className="mx-auto"
                alt="產品說明/UX200"
                loading="lazy"
                height={600}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="flex justify-center items-center">
                <div className="container mx-auto md:w-full  flex flex-col justify-center items-center center">
                  ...
                  <p className=" w-full text-center lg:w-2/3 ">
                    UX200
                    除了具備UX100的全部功能，更增加了pH/電位趨勢記錄曲線，電位解析度更提高至0.1
                    mV。可以更精確判定酸鹼滴定終點。滿足連續或頻繁記錄pH變化的需求。使用者不需一直待在機器旁邊記錄數據，可以隨時回溯實驗階段每個時間點的pH變化。
                  </p>
                </div>
              </div>
              <div className="">
              ...
              <div className="grid grod-cols-1 md:grid-cols-4 mx-auto md:w-full   lg:w-2/3  ">
                ...
                <div className="p-1 mx-auto lg:p-5">
                  <Image
                    ...
                    width={400}
                    height={400}
                    src="application-2.webp"
                    alt="廢水排放檢測"
                  ></Image>
                  <p className="text-[16px] text-center">廢水排放檢測</p>
                </div>
                <div className="p-1 mx-auto lg:p-5">
                  <Image
                    loader={myLoader}
                    ...
                    width={400}
                    height={400}
                    src="application-3.webp"
                    alt="廢水排放檢測"
                  ></Image>
                  <p className="text-[16px] text-center">電鍍酸鹼度控制</p>
                </div>
                <div className="p-1 mx-auto lg:p-5">
                  <Image
                    loader={myLoader}
            ...
            <div className="row flex flex-col md:flex-row  justify-center  w-full">
              <div className="right mt-3 md:mt-0  flex md:hidden  items-center  pt-[20px] md:pt-0  mx-auto w-4/5 md:w-3/4 xl:w-1/2">
                <div className="container-text-wrap mx-auto">
                  ...
                  <p className="text-middle-u text-center">
                    7.0寸的全彩觸控螢幕，清楚簡明的圖形選單，提供直覺操作體驗，讓您立即進行測量。
                  </p>
                </div>
              </div>
              <div className="left mt-2 md:mt-0 p-0 md:p-10 w-full md:w-3/4  xl:w-2/3">
                <Image
                  ...
                  className="mx-auto"
                  width={500}
                  src="UX200-11-操作指引02-720x540.webp"
                ></Image>
              </div>
            ...
            <div className="row flex flex-col md:flex-row  justify-center  w-full">
              ...
              <div className="left mt-2 md:mt-0 p-0 md:p-10 w-full md:w-3/4  xl:w-2/3">
                <Image
                  ...
                  width={500}
                  className="mx-auto"
                  src="UX200-03-智能結果判讀720x540.webp"
                  alt="智能結果判讀"
                ></Image>
              </div>
            </div>
...
"
        ...
        <section className="section_banner02 section h-[450px] relative mt-[50px] overflow-hidden lg:h-[576px] 2xl:h-[700px]">
          <Image
            className="absolute hidden xl:block z-20 top-0 left-0"
          ...
          ></Image>
          <Image
            className="absolute hidden sm:block xl:hidden z-20 top-0 left-0"
            src="UX100-11-方便攜帶-無字版-1024x576.webp"
            placeholder="empty"
            loader={myLoader}
            loading="lazy"
            alt="輕鬆手持方便攜帶"
          ...
          ></Image>
          <Image
            className="absolute block sm:hidden z-20 top-0 left-0"
          ...
          <div className="txt  absolute left-[15px] md:left-[50px] z-20 w-[90%] md:w-2/5 top-[25%] md:top-[14%] lg:top-[33%]">
            ...
            <p className="text-white xl:text-[18px] text-left mx-auto">
              540g
              的輕巧重量，適合手持操作的大小。皮革質感防滑設計，可輕鬆單手完成操作。配合方便攜帶的拋棄式蜂鳥探針電極{" "}
              <a
                href="https://www.ultraehp.com/hummingprobe/UH1.html"
                className="hover:text-orange-500 border-white border-b "
              >
                (瞭解更多)
              </a>{" "}
              無需層層保護，輕鬆移動。
          ...
          <div className="container section px-5 lg:px-[50px] xl:px-[100px]">
            <div className="row  mt-4 md:mt-0 flex flex-col md:flex-row  justify-center  w-full">
              <div className="right mt-3 md:mt-0 flex md:hidden items-center w-full md:w-1/2">
                <div className="container-text-wrap mx-auto">
                  <h3 className="h3-u text-center">各種場合都可提供清晰顯示</h3>
                  <p className="text-middle-u text-center">
              ...
              <div className="left mt-2 md:mt-0 p-0 md:p-10 w-full md:w-1/2">
                <Image
                  ...
                  className="mx-auto"
                  width={500}
                  src="UX200-05-手拿方便-720x540.webp"
                ></Image>
              </div>
            ...
            <div className="row  mt-4 md:mt-0 flex flex-col md:flex-row  justify-center  w-full">
              ...
              <div className="left mt-2 md:mt-0 p-0 md:p-10 w-full md:w-1/2">
                <Image
                  ...
                  width={500}
                  className="mx-auto"
                  src="UX200-08-高校充電電池720x540.webp"
                  alt="高校充電電池"
                ></Image>
              </div>
            </div>
            <div className="row  mt-4 md:mt-0 flex flex-col md:flex-row justify-center   w-full">
              ...
              <div className="left mt-2 md:mt-0 p-0 md:p-10 w-full md:w-1/2">
                <Image
                  ...
                  width={500}
                  className="mx-auto"
                  src="UX200-07-手持拍照-720x540.webp"
                  alt="內置鏡頭"
                ></Image>
              </div>
              <div className="right hidden  md:flex items-center  w-full md:w-1/2">
        ...
        <section className="section">
          <div className="Container px-0 md:px-[20px] xl:px-[200px] ">
            <div className="grid grid-cols-1">
              <div className="row  flex items-center flex-col  justify-center"></div>
              <div className="row">
                <div className="relative w-full grid md:grid-cols-2  md:px-0 lg:px-20">
                  ...
                  <div className="mt-5 px-0 md:px-3">
                    <Card className="py-4">
                      <CardHeader className="pb-0 pt-2 px-4 flex-col items-center">
                        <h3 className="text-[26px]">IP54防水防塵等級</h3>
        ...
        <section className="section">
          <div className="Container px-0 md:px-[20px]  ">
            <div className="grid grid-cols-1">
              <div className="row">
                <div className="relative w-full grid lg:grid-cols-2  md:px-0 lg:px-20"></div>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="w-[60%] px-20 ">
              <div className="txt  pl-[20%]">
                ...
                <p className="mt-2 dark:text-white text-base text-gray-800">
                  ...
                  <a
                    href="https://www.ultraehp.com/hummingprobe/UH1.html"
                    className="border-b-2 hover:text-orange-500 border-b border-white "
                  >
                    (瞭解更多)
                  </a>{" "}
                  無需層層保護，輕鬆移動。
        ...
        <section className="section_banner01 section relative  h-[450px] lg:h-[500px] xl:h-[768px]">
          ...
          <div className="txt  absolute left-[15px] md:left-[80px] z-20 w-[90%] md:w-2/5 top-[25%] md:top-[14%] lg:top-[33%]">
            <h3 className="text-[32px]">最佳化的行動實驗室</h3>

            <p className="text-white text-[16px] md:text-[18px]">
              UX200提供拍攝功能，針對每一筆數據，可拍照記錄現場環境，樣品編號細節。滿足結果分析朔源，原始數據的管理需求。並可將數據輕鬆傳輸至電腦保存備份
            </p>
          </div>
        </section>
              ...
              <div className="row  flex items-center flex-col  justify-center">
                ...
                >
                  <motion.h2
                    ...
                    variants={title01}
                  >
                    <h2 className="h2-u">Humming Probe UX200</h2>
                    <p className="text-model-u">免校正酸鹼檢測儀</p>
                  </motion.h2>
                  ...
                  >
                    <a
                      download="https://www.ultraehp.com/images/DM/UltraE-DM-v2.pdf"
                      href="https://www.ultraehp.com/images/DM/UltraE-DM-v2.pdf"
                      className="rounded-full w-[150px] text-center font-black bg-orange-500 text-white py-2 px-4 mx-auto mb-[50px]"
                    >
                      DM 下載
                    </a>
                  </motion.p>
              ...
              <div className="row">
                <div className="grid grid-cols-1 lg:grid-cols-2">
                  <div className="p-10 items-end flex flex-col">
                    ...
                    ></Image>
                    <Image
                      src="UX200-12-產品說明-720x540_工作區域 1-2.webp"
                      loader={myLoader01}
                      placeholder="empty"
                      className="mr-0 md:mr-[100px] w-full  md:w-1/2"
                      alt="UX100_酸鹼檢測器-尺寸圖"
