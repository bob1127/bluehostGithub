...
const ProductPost = {
  ...
  description:
    "免校正微量拋棄式pH酸鹼檢測電極/蜂鳥探針Humming Probe UH1具有無需使用校正液校正，打開即用的拋棄式設計。微升級的樣品需求量，適合只有珍貴樣品及易污染或鈍化pH電極表面和特殊樣品。無電極保存液方便攜帶，適合戶外無電源使用。酸鹼測試電極",
  image:
...
const Product = (props) => (
  <div className="relative">
    ...
    {/* meta seo tag */}
    <title>
      蜂鳥探針-UH1｜免校正微量拋棄式pH酸鹼檢測電極｜微升級樣品｜Humming
      Probe｜超極生技UltraE
    </title>
    <meta
      key="description"
      name="description"
      content="免校正微量拋棄式pH酸鹼檢測電極/蜂鳥探針Humming Probe UH1具有無需使用校正液校正，打開即用的拋棄式設計。微升級的樣品需求量，適合只有珍貴樣品及易污染或鈍化pH電極表面和特殊樣品。無電極保存液方便攜帶，適合戶外無電源使用。酸鹼測試電極"
    />
    <meta
      name="keywords"
      content="免校正微量酸鹼電極|酸鹼試片|酸鹼檢測|pH試片電極|pH電極|pH試片|"
    />
      ...
      <div className="fullscreen relative mt-[20px] md:mt-0 pt-[60px]">
        <a href="https://www.ultraehp.com/hummingprobe/">
          <Image
            ...
            width={160}
            loading="lazy"
            className="fixed mt-2 ml-[20px] md:ml-[109px] z-50 top-[60px] left-10"
            alt="UltraP-logo"
            height={60}
          ></Image>{" "}
        </a>
        ...
        <section className="section  mt-0 md:mt-[150px]">
          <div className="Navgation hidden md:block mb-[30px] pl-[150px]">
            {" "}
          ...
          <div className="container  w-full flex px-[0px] md:px-[20px] xl:px-[70px] flex-col md:flex-row justify-start items-start">
            ...
            <div className="right flex justify-center  md:justify-between md:pl-[50px] xl:pl-[80px] w-full md:w-1/2 flex-col  h-[480px]">
              <div className="txt">
                ...
                <h2 className="model-u">
                  酸鹼試片/酸鹼檢測/pH試片電極/pH電極/pH試片
                </h2>
                <p className="text-middle-u">
                  全球首創免校正酸鹼量測的方法，創新技術將電極量測原理整合在單一試片上。採用試片電極檢測pH值，具備以下特色:
                </p>
                <ul>
                  <li>・即開即用 ，精準免校正</li>
                  <li>・樣品使用量最少(10~20μL)</li>
                  <li>・拋棄式電極無交叉汙染</li>
                  <li>・精準度可達 ±0.1 pH</li>
                  <li>・每片試片內建溫度感測元件</li>
                  <li>・易於攜帶</li>
            ...
            <div className="bottom flex flex-col  md:flex-row fjustify-end items-start">
              <div className="left w-full md:w-[70%] xl:w-1/2">
                <Image
                  ...
                  width={600}
                  height={600}
                  alt="免校正微量拋棄式pH酸鹼檢測電極/蜂鳥探針電極樣品需求可降至微升級/Humming Probe UH1/超極生技UltraE"
                ></Image>
              </div>
              <div className="right p-0 md:pl-[20px] md:w-[80%] xl:w-1/2">
                <div className="top  mt-3  rounded-2xl p-[50px]  bg-orange-500">
                  <b className="text-white">一滴即可測量</b>
                  <br />
                  <b>UH1電極尺寸降低至10 毫米 樣品需求量更是可減少到10微升</b>
                  <p className="mt-3 text-[14px]  w-full sm:w-[80%] md:w-full">
                    生物樣品例如血液，唾液，腦髓液，組織液等都無法大量採樣。通常這類量少的樣品需要購買價格昂貴的超小型的玻璃pH計電極才能完成測試。UH1可通過取樣滴加，或是蘸取的方式完美提供解決方案。
                    *UH2提供更低至1微升的样品需求量{" "}
                ...
                <div className="bottom flex flex-col md:flex-row justify-start items-start">
                  <div className="right w-full  md:w-1/2">
                    <Image
                      ...
                      src="UH1-31.webp"
                    ></Image>
                    <p className="text-center">體液(汗液)檢測</p>
                  </div>
                  <div className="left w-full md:w-1/2">
                    <Image
                      ...
                      src="UH1-06.webp"
                    ></Image>
                    <p className="text-center">發酵過程控制</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bottom flex flex-col  md:flex-row fjustify-start items-start">
              <div className="right p-0 md:pr-[20px] md:w-[80%] xl:w-1/2">
                <div className="top  mt-3  rounded-2xl p-[70px] bg-orange-500">
                  <b className="text-white">拋棄式設計，拓寬在各領域的應用</b>
                  <br />

                  <p className="mt-3 text-[14px]  w-full sm:w-[80%] md:w-full">
                    每一次使用只需從密封罐內取出全新的試片，且在測試後無需費時清洗保養。對於粘稠或容易吸附的樣品或配合各種特殊處理，突破傳統pH玻璃電極種種限制，提供您更多的應用。
                  </p>
                </div>
                <div className="bottom flex flex-col md:flex-row justify-start items-start">
                  <div className="right w-full  md:w-1/2">
                    <Image
                      loader={myLoader01}
                      alt="免校正微量拋棄式pH酸鹼檢測電極/蜂鳥探針電極可用以經過滅菌滅活處理測試培養基酸鹼值/Humming Probe UH1/超極生技UltraE"
                      placeholder="empty"
                      loading="lazy"
                      height={450}
                      width={450}
                      src="UH1-03.webp"
                    ></Image>
                    <p className="text-center">可配合進行殺菌滅活的特殊處理</p>
                  </div>
                  <div className="right w-full  md:w-1/2">
                    <Image
                      loader={myLoader01}
                      placeholder="empty"
                      alt="免校正微量拋棄式pH酸鹼檢測電極/蜂鳥探針電極可用以用於測試粘稠不易清理樣品/Humming Probe UH1/超極生技UltraE"
                      loading="lazy"
                      width={550}
                      height={550}
                      src="UH1-04.webp"
          ...
          <div className="card-wrap  justify-center flex flex-wrap ">
            <div className="card bg-white h-full shadow-xl  md:m-3 overflow-hidden border rounded-2xl w-full md:w-[340px] p-6">
              <div className="txt ">
                ...
                <ReadMoreReact
                  text="我們提供高精度要求的pH量測，結果可以顯示至0.01，精確度可達±0.1 pH。測試pH值從0到14 ，皆可滿足。
...
"
            ...
            <div className="card h-full shadow-xl md:m-3 overflow-hidden border rounded-2xl w-full md:w-[340px] p-6">
              <div className="txt ">
                ...
                <ReadMoreReact
                  text="我們使用獨特設計的印刷電極搭配離子膜。沒有內參比液滲漏的問題，不會與樣品發生反應（蛋白質樣品等）。適合更廣泛的樣品。提供穩定長時間連續測試達幾十小時。
...
"
              ...
              <div className="img">
                <Image
                  ...
                  className="rounded-2xl mt-3"
                  height={400}
                  src="UH1-20-不使用液體的內參比電極720x540.webp"
                  placeholder="empty"
                  loading="lazy"
                  loader={myLoader}
                ></Image>
...
"
        ...
        <section className="px-[20px] md:px-0">
          <div className="container mx-auto ">
            <div className="section_table flex flex-col justify-center ">
              <h2 className="h2-u">蜂鳥探針pH檢測電極準確度如何？</h2>

              <b className="text-[14px] mt-[20px] mb-3 text-center text-gray-600 font-light">
                將量測數據與NIST standard pH
                buffer數值比較，依線性迴歸方程式可得相關係數
              </b>
              ...
              <div className=" w-full  px-0 md:px-10">
                <Table aria-label="Example  static collection table">
                  <TableHeader className="bg-none">
                    <TableColumn
                      colSpan={5}
                      className=" border-b-black bg-white  border-b-2  text-center font-extrabold text-gray-800 text-[18px]"
                    >
                      {" "}
                      UH1 測量數值與NIST pH Buffer 比較
                    </TableColumn>
                  ...
                  <TableBody>
                    <TableRow key="1">
                      ...
                      <TableCell>pH 0 - 14*</TableCell>
                    </TableRow>
                    <TableRow key="2">
                      <TableCell>斜率： </TableCell>
                      <TableCell> 1.0029</TableCell>
                    </TableRow>
                    <TableRow key="3">
                      <TableCell>截距： </TableCell>
                      <TableCell>-0.0521</TableCell>
                    </TableRow>
                    <TableRow key="4">
                      <TableCell>相關係數(r)： </TableCell>
                      <TableCell>0.9999</TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
                <p className="text-[14px] mt-1">*pH 0溶液為1.0 M HCl溶液</p>
                <p className="text-[14px] mt-1">pH 14溶液為 1.0 M NaOH溶液</p>
              </div>
            </div>
          ...
          <div className="card-wrap justify-center flex flex-wrap ">
            <div className="card shadow-xl  md:m-3 overflow-hidden border rounded-2xl w-[340px] p-6">
              <div className="txt h-[70px]">
                <p className="text-[18px] text-center font-black">線性關係</p>
                <p className="text-normal text-center text-[14px] ">
                  Linearity
                </p>
              </div>
              <div className="img">
            ...
            <div className="card  shadow-xl md:m-3 overflow-hidden border rounded-2xl w-[340px] p-6">
              <div className="txt h-[70px]">
                <p className="text-[18px] text-center font-black">精密度</p>
                <p className="text-normal text-[14px] text-center ">
                  Precision
                </p>
              </div>
              <div className="img">
            ...
            <div className="card shadow-xl md:m-3 overflow-hidden border rounded-2xl w-[340px] p-6">
              <div className="txt h-[70px]">
                <p className="text-[18px] text-center   font-black">準確度</p>
            ...
            <div className="container flex flex-col  sm:flex-row justify-center  mx-auto  w-full  xl:w-[80%]">
              <div className="left flex flex-col justify-center items-center m-3 border rounded-2xl p-10 w-full xl:w-1/2">
                <Image
                  ...
                  width={600}
                  height={600}
                  className="rounded-2xl md:w-full lg:w-2/3 "
                />
                <div className="txt font-normal text-[14px] text-center">
                  在品質管理上，所有試片及儀器的生產皆由UltraE完成，除了精確掌握生產技術外，亦全程控管產品品質，試片由原料開始，從基底裸片印刷，到高分子薄膜製程，與溫度感測器組裝製程，並且以百分之百全檢的模式確保產品穩定性。亦有正式通過ISO
                  9001：2015 認證，向我們的合作夥伴確保品質無虞及標準化的流程。
                </div>
                <div
                  href=""
                  className="bg-orange-500 rounded-full w-[220px] text-center px-4 py-2  mt-3 text-white "
                >
                  ISO 認證
                </div>
              </div>
              <div className="right m-3 flex flex-col justify-center border rounded-2xl  p-10 items-center w-full xl:w-1/2">
                ...
                <div
                  href=""
                  className="bg-orange-500 rounded-full w-[220px] text-center px-4 py-2  text-white mt-3"
                >
                  SGS 實驗室測試報告
                </div>
              </div>
        ...
        <section className="hidden section">
          <div className="section_brand">
            <div className="container">
              <h2 className="h2-u ">
                Trusted by precision laboratory <br />
                in universities and enterprises
              </h2>
        ...
        <section className="section">
          <div className="container">
            <div className="row">
              <h2 className="text=[26px] w-4/5 text-center mx-auto">
        ...
        <section className="">
          <div className="container px-[15px] w-full xl:w-[1000px]  ">
            <h2>如何使用蜂鳥探針pH檢測電極？</h2>
            <p className="w-full px-[20px] md:px-0 md:w-3/4 text-center mx-auto">
              蜂鳥探針在出廠前皆使用NIST
              認證可追溯性標準品進行校正檢驗，並將批次校正資訊以QRcode模式結合在試片罐上，首次使用時只需將pH檢測儀掃描試片罐上QRcode後，即可直接進行pH量測。使⽤上不同於傳統pH玻璃電極，無需進行傳統繁雜的校正步驟。
            </p>
            <div className="grid  grid-cols-1 md:grid-cols-3">
              <div className="p-4 mx-auto">
                <Image
                  loader={myLoader01}
                  alt="免校正微量拋棄式pH酸鹼檢測電極/蜂鳥探針電極的使用方法/Humming Probe UH1/超極生技UltraE"
                  src="即開即用.webp"
                  placeholder="empty"
                  loading="lazy"
                  width={400}
              ...
              <div className="p-4 mx-auto">
                ...
                <b>測量方式1.</b>
                <br></br>
                <b className="text-center ">由檢測片直接吸取樣品後測試</b>
              </div>
              <div className="p-4 mx-auto">
                <Image
                  loader={myLoader01}
          ...
          <div className="Container md:px-20">
            <div className="grid grid-cols-1">
              <div className="row  flex items-center flex-col  justify-center">
                <h2 className="h2-u">UH1-酸鹼試片電極</h2>
                ...
                <a
                  ...
                  className="rounded-full font-black mt-4 text-center w-[150px]  bg-orange-500 text-white py-2 px-4 mx-auto mb-[50px]"
                >
                  DM 下載
                </a>
              </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2">
                  <div className="p-0 xl:p-10 items-end flex flex-col">
                    <Image
                      ...
                      loading="lazy"
                      placeholder="empty"
                      className="mr-0 md:mr-[100px] w-full"
                      alt="免校正微量拋棄式pH酸鹼檢測電極/蜂鳥探針電極的尺寸規格及包裝規格/Humming Probe UH1/超極生技UltraE"
                      width={600}
                      height={600}
                    ></Image>
                  </div>
