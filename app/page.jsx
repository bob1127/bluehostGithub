...
export default async function Home() {
  ...
  const ProductPost = {
    title:
      "超極生技｜快速胃幽門螺旋桿菌檢測，拋棄式免校正pH儀器｜極安簡測 & 蜂鳥探針",
    description:
  ...
  return (
    <div className="bg-white">
      ...
      {/* metadata */}
      <title>
        超極生技-UltraE｜快速胃幽門螺旋桿菌H.
        Pylori尿素呼吸檢測｜拋棄式免校正pH酸堿度檢測｜極安簡測 & 蜂鳥探針
      </title>
      <meta
        key="description"
        name="description"
        content="超越傳統感測技術，實現卓越的健康生活。我們引以為傲的PotentioStrip專利技術，為您帶來兩大品牌，第一款是針對醫療健康需求的極安簡測-胃幽門螺旋桿菌快速呼吸檢測組，第二款則是為改進檢測體驗而設計的拋棄式免校正pH檢測系列。  "
      />
      <meta
        name="keywords"
        content="胃幽門桿菌|H. Pylori/pH meter/pH感測器/pH測量儀/酸鹼度計/pH檢測器/pH值檢測計/可攜式 pH 計/桌上型pH計/pH測量儀 /pH電極/酸鹼度計/酸鹼測試/pH測試"
      />
      ...
      <meta
        property="og:title"
        content="超極生技-UltraE｜快速胃幽門螺旋桿菌H. Pylori尿素呼吸檢測｜拋棄式免校正pH酸堿度檢測｜極安簡測 & 蜂鳥探針"
      />
      <meta
      ...
      <meta
        property="og:image"
        content="https://www.ultraehp.com/images/index/UltraE-hero.webp?w=1920"
      />
      ...
      <div className="outWrap overflow-hidden ">
          ...
          <Dropdown>
            ...
            <DropdownMenu aria-label="Static Actions">
              <DropdownItem key="new">
                <a className="block w-full" href="https://www.ultraehp.com/en">
                  English
                </a>
              </DropdownItem>
              <DropdownItem key="new">
                <a href="https://www.ultraehp.com/ " className="block w-full">
                  繁體中文
                </a>
              </DropdownItem>
            </DropdownMenu>
        ...
        <a href="https://www.ultraehp.com/">
          <Image
            ...
            loading="lazy"
            placeholder="empty"
            className="fixed mt-3 ml-[20px] md:ml-[135px] z-50 top-[60px] left-10"
            alt="Ultrae-logo"
            height={60}
          ></Image>{" "}
        </a>
        ...
        <section className="section_HeroVideo p-0 relative h-auto md:h-[576px] 2xl:h-[768px] lg:h-[600px] mt-[100px]  ">
          <Image
            ...
            fetchPriority="high"
            placeholder="empty"
            alt="免校正微量拋棄式pH計酸鹼檢測儀開機自動自檢校正Humming"
            src="超極首頁輪播圖-無字1920X768.webp"
            width={1920}
            height={768}
          />
          ...
          <Image
            ...
            fetchPriority="high"
            placeholder="empty"
            alt="快速胃幽門螺旋桿菌檢測-mobile"
            src="超極首頁輪播圖-無字640X640.webp"
            width={640}
            height={640}
            className="block md:hidden"
          />

          <div className="relative border border-black  w-full lg:w-[500px] h-auto lg:h-[500px] block md:hidden  "></div>
          ...
          <div className="HeroTitle   pl-[20px] md:pl-[40px] top-[10%] md:top-[15%] lg:top-[15%] xl:top-[27%] w-full md:w-[90%] md:w-[50%] md:left-[7%] 2xl:left-[14%]  mt-[30px] md:mt-0 relative  md:absolute    ">
            ...
            >
              <motion.div
                variants={stagger}
                className="inner flex  flex-col md:justify-start justify-center md:items-start items-center w-full pr-2"
              >
                <motion.div variants={fadeInUp}></motion.div>
                <motion.h1
                  className="text-gray-800 text-center md:text-left w-3/4 text-[26px] leading-normal md:text-[30px] lg:text-[50px]"
                  variants={fadeInUp}
                >
                  超越感測界線，極致健康生活
                  <br />
                ...
                <motion.p
                  className=" text-gray-800 mt-4 w-full md:w-1/2 xl:w-1/3 2xl:text-[22px] md:text-[16px] text-[16px]"
                  variants={fadeInUp}
                >
                  我們針對食品與水質檢測發展與日常生活息息相關之感測器，以減少有害物質攝取與接觸
                  ，達到守護人類健康的願景
                </motion.p>
                ...
                <motion.div variants={fadeInUp} className="btn-row">
                  <div className="mt-10">
                    <a
                      ...
                      className="bg-orange-500 text-white font-light text-[14px] text-center  rounded-full w-[150px] md:w-[180px] text-white px-4 mt-3 py-2 "
                    >
                      關於超極生技
                    </a>
                  </div>
        ...
        <section>
          <div className="line  mt-[50px] md:mt-[20px] p-4">
            <p className="text-[30px] blank02 font-bold text-center text-gray-800">
              - CORE TECH -
            </p>
          </div>
        </section>
        ...
        <section className="relative">
          ...
          <Image
            ...
            fetchPriority="high"
            placeholder="empty"
            alt="免校正微量拋棄式pH酸鹼檢測電極/蜂鳥探針可提供微升級的樣品測試/Humming Probe UH1/超極生技UltraE"
            src="UltraP核心技術圖-無字1920X768.webp"
            width={1920}
            height={768}
          />
          <div className="txt w-full md:w-[35%] flex relative md:absolute right-0 md:right-[6%] xl:right-0 xl:ml-[50px]  sm:top-[22%] xl:top-[35%] items-center md:items-start justify-center md:justify-start py-[30px] flex-col">
            <h2 className="bg-sky-600 text-white relative text-[14px] px-4 py-2 rounded-[40px] w-[150px] md:w-[220px] font-normal  ">
              我們的核心技術-PotentioStrip{" "}
              <span className="border absolute border-white  rounded-full flex items-center justify-center right-[11px] md:right-[5px] top-[8px] text-[8px] w-[12px] text-white h-[12px]">
                R
              </span>
            </h2>
            <h2 className="text-black md:text-white font-normal xl:font-extrabold text-[16px] md:text-[20px] xl:text-[30px] text-center md:text-left mt-3">
              我們讓試片長出自己的電路系統
            </h2>
          </div>
        </section>

        <section className=" px-5  md:px-15 lg:px-20"></section>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2">
                  ...
                  <div className="flex flex-col items-end">
                    <div className="text flex flex-col  w-full">
                      ...
                      <p className="w-1/2 mb-10 dark:text-white">
                        UltraPeace-Instant H. Pylori Urea Breath Test kit-Pro
                      </p>
                    </div>
                    {/* <Accordion /> */}
                  </div>
                  ...
                  <div className=" dark:bg-slate-900  bg-[indexCard] rounded-3xl lg:h-[500px] justify-around flex flex-col items-center py-10">
                    <div className="top-wrap">
                      <div className="txt flex flex-col items-center mb-5">
                        <b className="text-3xl dark:text-white">
                          ToothBaste Bits
                        </b>
                        <p className="font-extralight dark:text-slate-200">
                          from Ind / Month
                        </p>
                      </div>
                      <div className="imgWrap overflow-hidden rounded-full w-[280px] h-[280px] border border-black"></div>
                    </div>
                    ...
                    <div className="bottom-wrap">
                      <div className="bottom w-full flex justify-between">
                        ...
                        <a
                          ...
                          className="go-btn dark:text-slate-300"
                        >
                          Go to Products
                        </a>
                      </div>
        ...
        <section>
          <div className="line mt-[44px]  p-4">
            <p className="text-[30px] text-center font-bold text-gray-800">
              - BRAND -
            </p>
          </div>
        </section>
        ...
        <section className="section_FullBanner01 px-[20px] lg:px-[px]  flex-col md:flex-row flex items-center justify-center">
          <div className="text-wrap w-full md:w-1/2  flex justify-center items-center  flex-col mb-4 md:mb-0  px-4 md:block   lg:hidden">
            ...
            <p className="mt-2 text-[16px] sm:text-[18px] md:text-[22px]  mb-3">
              30分鐘立即獲得尿素呼吸測試結果
            </p>
            <a
              href="https://www.ultraehp.com/ultrapeace/"
              className="bg-[#964d78] font-light text-[14px] text-center  rounded-full w-[150px] md:w-[180px] text-white px-4 mt-3 py-2 "
            >
              {" "}
              關於極安簡測
            </a>
          ...
          <div className="container  w-full xs:w-[75%] md:w-1/2 lg:w-full lg:block h-[400px] md:h-[340px]  relative lg:h-[500px] 2xl:h-[768px] rounded-2xl overflow-hidden ">
            <div className="absolute top-0 left-0  mx-auto">
              <Image
                src="UltraP幽門桿菌人體胃痛視覺圖-無字1920X768.webp"
                width={1920}
                placeholder="empty"
                alt="幽門桿菌人體胃痛視覺圖"
                height={768}
              ...
              <Image
                src="UltraP幽門桿菌人體胃痛視覺圖-無字640X640.webp"
                width={650}
                loading="lazy"
                alt="幽門桿菌人體胃痛視覺圖"
                loader={myLoader04}
        ...
        <section className="section_FullBanner02  my-6 px-[20px] lg:px-[px] flex-col md:flex-row flex items-center justify-center">
          <div className="text-wrap w-full md:w-1/2 flex flex-col justify-center items-center px-4 md:block lg:absolute  ">
            ...
            <a
              href="https://www.ultraehp.com/hummingprobe"
              className="bg-[#b5a27e] font-light text-[16px] text-center  rounded-full mb-[30px] lg:mb-0 md:w-[250px] sm:w-[220px]  w-[150px] md:w-[180px] text-white px-4 mt-3 py-2 "
            >
              關於蜂鳥探針
            </a>
          </div>
          <div className="container   w-full md:w-1/2 lg:w-full lg:block h-[400px] md:h-[340px] relative lg:h-[500px] 2xl:h-[768px] rounded-2xl overflow-hidden ">
            <div className="absolute top-0 left-0  mx-auto">
              <Image
                alt="免校正拋棄式微量pH酸鹼檢測系統/蜂鳥探針 Humming Probe/超極生-UltraE"
                src="蜂鳥探針主視覺圖-無字1920X768.webp"
                width={1920}
                height={768}
                loader={myLoader05}
                className=" mx-auto hidden lg:block"
            ...
            <div className="text-wrap mb-5 my-4 md:my-0 lg:absolute  w-full md:w-1/2 left-[150px] top-[25%] ">
              ...
              <p className="mt-2 text-[22px] text-gray-700 mb-3">
                滿足你對pH檢測的全面需求
              </p>
              <a
                href="https://www.ultraehp.com/hummingprobe"
                className="bg-orange-500 font-light  text-center  rounded-full mt-4  w-[150px] md:w-[180px] text-[16px] text-white px-4  py-2 "
              >
                關於超極生技
              </a>
            </div>
        ...
        <section className="section_chip hidden pt-[20px] bg-black m-0 ">
          <div className="py-[30px] px-[25px] lg:px-0 mx-auto w-full md:2/3 lg:w-1/2">
            <div className="yxyx flex flex-col justify-center items-center border">
              <h2 className="text-[26px] text-white font-extrabold mx-auto">
                我們讓試片長出自己的電路系統
              </h2>
              <p className="text-white text-center ">
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Unde,
                nemo expedita cupiditate libero quisquam ea ex repudiandae,
                magnam ab harum possimus hic recusandae commodi magni porro
                repellendus quis sequi obcaecati!
              </p>

              <ModalBtn />

              <a href="https://www.ultraehp.com/en/ContactUs.html">
                聯絡工程師討論
              </a>
            </div>
          </div>
          <a href="https://www.ultraehp.com/ultrapeace/en/">
            <Image
              src="A2343211_TD03_V1_3078x.png"
              width={1920}
              height={700}
              loading="lazy"
              loader={myLoader00}
                    ...
                    <div className="card  m-4 h-[400px] border border-gray-300 flex flex-col  bg-[#f5f6f6] rounded-xl p-6 w-[350px] ">
                      <div className="img w-full  md:h-[230px]">
                        <Image
                          ...
                          width={400}
                          height={300}
                          src="三大優勢小圖icon-03.webp"
                        ></Image>
                      </div>
                      <div className="txt mt-[5px]">
                        <b className="text-[18px] ">環境污染</b>
                        <ul className="flex flex-col justify-start items-start">
                  ...
                  >
                    <section className="mx-[20px] ">
                      <div className="container py-6 flex flex-col justify-center  items-center  ">
                        <h3 className=" text-[22px] md:text-[30px] leading-[35px] font-normal text-black ">
                          如果還不確定是否適用
                          <br />
                          立即聯絡專人體驗我們的產品
                        </h3>
                        ...
                        <a
                          href="https://www.ultraehp.com/en/ContactUs.html"
                          className="w-4/5 md:w-2/3 mx-auto text-gray-600 text-center  lg:text-left"
                        ></a>
                        <a
                          href="https://www.ultraehp.com/ContactUs.html"
                          className="bg-orange-500 text-[14px] text-center mt-6 rounded-full w-[150px] text-white  py-2 "
                        >
                          聯絡我們!
                        </a>
                      </div>
