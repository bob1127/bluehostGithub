...
const ProductPost = {
  ...
  description:
    "免校正超微量拋棄式pH酸鹼檢測電極/蜂鳥探針Humming Probe UH2具有無需使用校正液校正，打開即用的 拋棄式設計。1微升級的超低樣品需求量，適合非常珍貴樣品及易污染或鈍化pH電極表面和特殊樣品。無電極保存液方便攜帶，適合戶外無電源使用。酸鹼測試電極",
  image:
...
const Product = (props) => (
  <div className="relative">
    {/* metadata */}
    <title>
      蜂鳥探針-UH2｜免校正超微量拋棄式pH酸鹼檢測電極｜微升級樣品｜Humming
      Probe｜超極生技UltraE
    </title>
    <link
      rel="alternate"
    ...
    <link
      rel="alternate"
      href="https://www.ultraehp.com/hummingprobe/en/UH2.html"
      hreflang="en"
    />
    ...
    <meta
      name="keywords"
      content="酸鹼測試/電極pH電極/酸鹼度計/酸鹼測試/pH測試/氣體酸鹼值連續檢測/尾氣廢氣檢測/氨氣+二氧化硫濃度檢測"
    />
...
"
    ...
    <meta
      property="og:image"
      content="https://www.ultraehp.com/images/Products-Detail-Img/UH2-Gas/UH2-GAS-氣體圖.webp"
    />
    <motion.div
...
"
        ...
        <section className="section_special section">
          <div className="container mt-[40px] lg:px-10 xl:px-20 mx-auto ">
            <h2 className="w-4/5 md:w-1/2  text-center mx-auto ">
              蜂鳥探針pH檢測電極UH2 除了免校正外還有有什麼特別之處？
            </h2>
            <div className="bottom   flex flex-col  md:flex-row fjustify-start items-start">
              ...
              <div className="right  md:w-[80%] xl:w-1/2">
                <div className="top px-[27px]  py-[70px]  rounded-2xl p-5 bg-orange-500 ml-0 md:ml-4">
                  <b className="text-white text-[20px]">業界最小的樣品需求量</b>
                  <br />
                  <b>UH2電極尺寸降低至2 mm 樣品需求量更是可小到1微升</b>
                  <p className="mt-3 text-[14px]">
                    生物樣品例如血液，唾液，腦髓液，組織液等都無法大量採樣。通常這類量少的樣品需要購買價格昂貴的超小型的玻璃pH計電極才能完成測試。UH2可以在幾乎不破壞檢體和無需預處理的狀況下完成檢測。
                  </p>
                </div>
                <div className="bottom flex ml-2 flex-col md:flex-row justify-start items-start">
                  <div className="left w-full md:w-1/2">
                    <Image
                      ...
                      src="UH2-01.webp"
                    ></Image>
                    <p className="text-center">活體(鱼血)檢測</p>
                  </div>
                ...
                <div className="bottom flex flex-col md:flex-row justify-center items-center">
                  <div className="left w-full md:w-1/2">
                    <Image
                      ...
                      src="UH1-03.webp"
                    ></Image>
                    <p className="text-center">可配合進行殺菌滅活等特殊處理</p>
                  </div>
                  <div className="right w-full  md:w-1/2">
                    <Image
                      loader={myLoader01}
        ...
        <section className="section">
          <div className="container mx-auto ">
            <div className="section_table flex flex-col justify-center items-center">
              ...
              <b className="text-[14px] w-full md:w-1/2 mt-[20px] mb-3 text-center text-gray-700 font-light">
            ...
            <div className="left pl-0 md:pl-[50px] xl:pl-[180px]  flex justify-center  items-center w-full lg:w-1/2   ">
              <div className=" w-full  px-0 md:px-10">
                ...
                <p className="text-[14px] mt-1">
                  *pH 0 solution is 1.0 M HCl solution
                </p>
                <p className="text-[14px] mt-1">
                  pH 14 solution is 1.0 M NaOH solution SGS
                </p>
              </div>
            </div>
...
"
                  ...
                  height={400}
                ></Image>
                <b className="mt-3 opacity-0">測量方式1.</b>
                <b className="text-center mt-3 md:mb-0">於罐中取出酸鹼試片</b>
              </div>
              <div className="mt-4 flex justify-center items-center flex-col md:mt-0 mr-0 md:mr-[15px]">
                <Image
                  ...
                  height={400}
                ></Image>
                <b className="mt-3">測量方式1.</b>
                <br></br>
                <b className="text-center mb-3 md:mb-0 text-[16px]">
                  由檢測片直接吸取樣品後測試
                </b>
              </div>
              <div className="mt-4 md:mt-0 flex justify-center items-center flex-col">
                <Image
                  ...
                  height={400}
                ></Image>
                <b className="mt-3">測量方式2.</b>
                <br></br>
                <b className="mb-3 md:mb-0">或將檢測片置入樣品溶液中測試</b>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="section_double section">{/* <Double/> */}</section>
        <section className="section">
          <div className="Container  md:px-20">
            <div className="grid grid-cols-1">
              <div className="row  flex items-center flex-col  justify-center">
                <h2 className="text-[32px]">UH2 酸鹼試片電極</h2>
                ...
                <a
                  ...
                  className="rounded-full w-[150px]  bg-orange-500 text-white font-black text-center py-2 px-4 mx-auto mb-[50px]"
                >
                  DM 下載
                </a>
              </div>
                                ...
                                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                  <tbody>
                                    <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                      ...
                                      <td className="px-6 py-4">pH 0 - 14</td>
                                    </tr>
                                    <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                      <th
                                        scope="row"
                                      ...
                                      <td className="px-6 py-4">± 0.1 pH</td>
                                    </tr>
                                    <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                      <th
                                        scope="row"
                                      ...
                                      <td className="px-6 py-4">1 - 2μL</td>
                                    </tr>
                                    <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                      <th
                                        scope="row"
            ...
            <div className="grid grid-cols-1">
              <div className="row  flex items-center flex-col  justify-center">
                ...
                >
                  ...
                  <motion.p className="text-m " variants={title02}>
                    {/* 
