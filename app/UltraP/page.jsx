...
const ProductPost = {
  ...
  description:
    "適用於診斷及檢測胃幽門螺旋桿菌，非侵入檢測方式,30分鐘立即獲得檢測成果,可用於評估治療前後效果, 自動判讀檢測成果,兩種版本: 專業版 / 居家檢測版本",
  ...
  LogoImg:
    "https://www.ultraehp.com/images/Products-Detail-Img/UP100/ultraP-logo.webp",
...
const Product = (props) => (
  <div className="relative">
    ...
    <title>
      極安簡測｜快速胃幽門螺旋桿菌檢測-UBTiw｜胃幽門桿菌｜胃幽門桿菌呼氣檢測
    </title>
    <meta
      key="description"
      name="description"
      content="適用於診斷及檢測胃幽門螺旋桿菌，非侵入檢測方式,30分鐘立即獲得檢測成果,可用於評估治療前後效果, 自動判讀檢測成果,兩種版本: 專業版 / 居家檢測版本"
    />
    ...
    <meta
      property="og:title"
      content="極安簡測｜快速胃幽門螺旋桿菌檢測-UBTiw｜胃幽門桿菌｜胃幽門桿菌呼氣檢測"
    />
    <meta
      property="og:description"
      content="胃幽門螺旋桿菌（Helicobacter pylori）是一種微小的革蘭氏陰性菌。胃幽門螺旋桿菌是螺旋狀且具有纖毛，這種形狀使得它能夠在胃部黏膜中穿梭移動。它表面的黏附分子能夠與胃部黏膜細胞表面的受體結合，這有助於它們固定在胃部黏膜上並避免被洗脫。這些特點使得胃幽門螺旋桿菌能夠在胃部環境中存活並定居，導致感染和相關的胃部問題。"
    />
    <meta
      property="og:image"
      content="https://asset.cloudinary.com/drmonozsf/6dc665fdc678c06ce447b5dfb772d746"
    />
    ...
    >
      ...
      <div className="fullscreen relative mt-[30px] pt-[90px] md:pt-[60px]">
        <a href="https://www.ultraehp.com/ultrapeace/">
          <Image
            loader={myLoader001}
            src="ultraP-logo.webp"
            width={160}
            loading="lazy"
            placeholder="empty"
            className="fixed mt-2 ml-[20px] md:ml-[109px] z-50 top-[60px] left-7"
            alt="UltraP-logo"
            height={60}
          ></Image>
        </a>
      ...
      <div className="content-bottom md:p/x-10 xl:px-15 2xl:px-20">
                ...
                >
                  ...
                  >
                    <div className="container flex justify-center flex-col items-center align-middle">
                      <h3 className="h3-Hp">什麼是胃幽門螺旋桿菌？</h3>
                      <p className="container-text-wrap text-Hp">
                        胃幽門螺旋桿菌（Helicobacter
                        pylori）是一種微小的革蘭氏陰性菌。胃幽門螺旋桿菌是螺旋狀且具有纖毛，這種形狀使得它能夠在胃部黏膜中穿梭移動。它表面的黏附分子能夠與胃部黏膜細胞表面的受體結合，這有助於它們固定在胃部黏膜上並避免被洗脫。這些特點使得胃幽門螺旋桿菌能夠在胃部環境中存活並定居，導致感染和相關的胃部問題。
                      </p>
                    </div>
                  </motion.h2>
                </motion.div>
        ...
        <Image
          src="H.PyloriInfect向量圖-1024x576.webp"
          loading="lazy"
          placeholder="empty"
          loader={myLoader}
          width={1024}
        ...
        <Image
          src="H.PyloriInfect向量圖-640x640.webp"
          loading="lazy"
          placeholder="empty"
          loader={myLoader}
          width={640}
                ...
                >
                  ...
                  >
                    <div className="container flex flex-col justify-center items-center center ">
                      <h3 className="h3-Hp">感染胃幽門螺旋桿菌</h3>
                      <p className=" container-text-wrap text-Hp">
                        感染幽門螺旋桿菌後，不同個體的反應會有所不同：某些個體可能不會出現明顯的症狀，即使他們已被幽門螺旋桿菌感染。另一些個體可能會因感染導致胃酸過量，進而引發幽門部胃炎和十二指腸潰瘍等併發症。另一類個體感染幽門螺旋桿菌後，可能進展為慢性胃炎，此狀況更增加罹患胃癌的風險。
                      </p>
                    </div>
                  </motion.h2>
                </motion.div>
                ...
                >
                  ...
                  >
                    <div className="container flex flex-col justify-center items-center center ">
                      ...
                      <p className="  container-text-wrap text-Hp">
                        胃幽門螺旋桿菌的感染方式主要通過飲食或口腔傳染。這種細菌可以存在於受感染者的唾液、口腔、嘔吐物或粪便中。它可以透過直接接觸、共用餐具、飲食中被污染的食物或水等途徑傳播。此外，感染者也可以通過接觸受感染者的嘔吐物或粪便而感染。
                      </p>
                    </div>
                  </motion.h2>
                </motion.div>
                <div className="row">
                  ...
                  >
                    ...
                    >
                      ...
                      <div>
                        <ul>
                          <li className="text-xs text-gray-800 font-normal text-left">
                            Ref：
                          </li>
                          <li className="text-xs text-gray-800 font-normal text-left">
                            1.JGH Open, Volume: 7, Issue: 1, Pages: 3-15, First
                            published: 21 November 2022, DOI:
                            (10.1002/jgh3.12843)
                          </li>
                          <li className="text-xs text-gray-800 font-normal text-left">
                            2. Ali Pormohammad, J Cell Physiol,
                            2019;234:1208–1218
                          </li>
                        </ul>
                      </div>
            ...
            <div className="grid grid-cols-1">
              <div className="row  flex items-center flex-col  justify-center">
                <motion.div
                  ...
                  transition={{ staggerChildren: 0.3 }}
                >
                  <h3 className="h3-Hp text-center">
                    胃幽門螺旋桿菌不同診斷方式比較
                  </h3>
                </motion.div>
                <div className="row">
                          ...
                          <div className="overflow-x-auto w-[430px] sm:w-[550px]  md:w-[920px] lg:w-[100%] ">
                            <div className="inline-block   py-2 sm:px-6 lg:px-8">
                              <div className="overflow-x-scroll w-full">
                                <table className="p-2  md:ml-[0px] w-[1000px] md:w-[1100px] border text-center text-sm font-light dark:border-neutral-500">
                                  <tbody>
                                    <tr className="border-b dark:border-neutral-500">
                                      ...
                                      <td className=" border-r  font-medium dark:border-neutral-800 bg-t-color-2">
                                        侵入式
                                      </td>
                                      <td
                                        colSpan={4}
                                    ...
                                    <tr className="border-b dark:border-neutral-500">
                                      <td className=" border-r p-0 md:p-4  font-medium dark:border-neutral-500">
                                        <Image
                                          src="內視鏡.webp"
                                          loader={myLoader}
                                          className="mx-auto"
                                      ...
                                      <td className=" border-r  p-0 md:p-4 dark:border-neutral-500">
                                        <Image
                                          src="糞便抗體檢測.webp"
                                          className="mx-auto"
                                          alt="內視鏡-icon"
                                    ...
                                    <tr className="border-b dark:border-neutral-500">
                                      <td className=" border-r  font-medium bg-t-color-2 dark:border-neutral-500">
                                        檢測方法
                                      </td>
                                      <td className=" border-r bg-t-color-3  dark:border-neutral-500">
                                        內視鏡
                                      </td>

                                      <td className=" border-r break-words dark:border-neutral-500 bg-t-color-4">
                                        糞便抗體檢測{" "}
                                      </td>
                                      <td className=" border-r bg-t-color-5 break-words dark:border-neutral-500">
                                        血清檢測{" "}
                                      </td>
                                      <td className="bg-t-color-6  border-r break-words dark:border-neutral-500">
                                        <sup>13</sup>C 尿素呼吸法
                                      </td>
                                      <td className="bg-t-color-7  border-r break-words dark:border-neutral-500">
                                        快速尿素呼吸法-UBT<span>IW</span>
                                      </td>
                                    </tr>
                                    <tr className="border-b dark:border-neutral-500">
                                      <td className=" border-r  font-medium bg-t-color-2 dark:border-neutral-500">
                                      ...
                                      <td className=" border-r  dark:border-neutral-500 bg-t-color-4">
                                        糞便{" "}
                                      </td>
                                      <td className=" border-r bg-t-color-5  dark:border-neutral-500">
                                        血液{" "}
                                      </td>
                                      <td className="bg-t-color-6  border-r  dark:border-neutral-500">
                                        呼出氣體{" "}
                                      </td>
                                      <td className="bg-t-color-7  border-r  dark:border-neutral-500">
                                        呼出氣體
                                      </td>
                                    </tr>
                                    ...
                                    <tr className="border-b dark:border-neutral-500">
                                      ...
                                      <td className=" border-r bg-t-color-4  dark:border-neutral-500">
                                        3-7 days
                                      </td>
                                      <td className="bg-t-color-5  border-r  dark:border-neutral-500">
                                        3-7 days{" "}
                                      </td>
                                      <td className="bg-t-color-6  border-r  dark:border-neutral-500">
                                        3-7 days{" "}
                                    ...
                                    <tr className="border-b dark:border-neutral-500">
                                      <td className="bg-t-color-2  border-r  font-medium dark:border-neutral-500">
                                        費用/NT
                                      </td>
                                      <td className=" border-r bg-t-color-3  dark:border-neutral-500">
                                        高
                ...
                >
                  ...
                  >
                    <div className="container flex flex-col px-4 justify-center items-center center ">
                      <h3 className="h3-Hp">檢測原理</h3>
                      <p className="  container-text-wrap text-Hp">
                        胃部感染胃幽門螺旋桿菌時，當我們服用尿素溶液後，胃幽門螺旋桿菌上的尿素酶會將尿素分解成二氧化碳和氨氣。我們通過檢測從呼吸中排出的氨氣，對比服用尿素前的背景數值，從而確定是否感染胃幽門螺旋桿菌。
                      </p>
                    </div>
                  </motion.h2>
                </motion.div>
                ...
                >
                  ...
                  >
                    <div className="container flex flex-col justify-center items-center px-0 md:px-[50px] center ">
                      <h3 className="h3-Hp w-2/3 md:w-full">
                        核心專利技術
                        <br />
                        拋棄式氣體pH電化學試片
                      </h3>
                      <p className="w-[85%]">
                        專利的納米孔洞水凝膜，會藉由水凝膜交換氣體後，在電極表面進行水解後可以直接檢測揮發性酸鹼氣體的pH值
                      </p>
                    </div>
                  </motion.h2>
                </motion.div>
                  ...
                  >
                    <div className="relative w-full grid grid-cols-1 lg:grid-cols-2 px-0 md:px-10 lg:px-20">
                      <div className="flex flex-col ">
                        <h3 class="h3-Hp">
                          用常規尿素替代<br></br>同位素標定的<sup>13</sup>C尿素
                          <span></span>
                        </h3>
                ...
                >
                  ...
                  >
                    <div className="relative w-full grid grid-cols-1 lg:grid-cols-2 px-0 lg:px-20">
                      <div className="flex flex-col ">
                        <h3 class="h3-Hp">一鍵自動檢測</h3>
                        <div className="px-0 lg:px-10 flex p-0 lg:p-7 flex-col items-center m-0 lg:m-3  ">
                          <Image
                            src="專業版產品圖-中文-01.webp"
                            loading="lazy"
                            alt="專業版胃幽門螺旋桿菌尿素呼吸檢測系統全部部件展示/極安簡測-UltraPeace/ 超極生技 UltraE"
                            loader={myLoader}
                            width={600}
                            height={600}
                          ></Image>
                      ...
                      <div className="flex flex-col">
                        <h3 class="h3-Hp ">專利整合試片無需meter</h3>
                        <div className="px-0 lg:px-10 flex p-0 lg:p-7 flex-col items-center m-0 lg:m-3  ">
                          <Image
                            placeholder="empty"
                            loading="lazy"
                            src="家用版產品圖-中文-01.webp"
                            width={600}
                            alt="家用版胃幽門螺旋桿菌尿素呼吸檢測系統全部部件展示/極安簡測-UltraPeace/ 超極生技 UltraE"
                            loader={myLoader}
                            height={600}
                          ></Image>
                        </div>
              ...
              <div className="row">
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-[14px] text-center font-normal">
                      For Research Only
                    </span>
                  </motion.h2>
                </motion.div>
