...
const VideoPlayer = () => {
    const videoUrl = 'https://ultraehp.com/images/Ultra Video/UH1/中文版/UH1中文版.mp4'; // Path to your local video file

    const posterUrl = 'https://ultraehp.com/images/Ultra Video/UH1/中文版/YouTube-UH1-中文.webp'; // Path to your video poster image
