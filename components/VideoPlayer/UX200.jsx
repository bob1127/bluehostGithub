...
const VideoPlayer = () => {
    const videoUrl = 'https://ultraehp.com/images/Ultra Video/UX200/英文版/UX200英文版.mp4'; // Path to your local video file

    const posterUrl = 'https://www.ultraehp.com/images/Ultra Video/UX200/英文版/YouTube-UX200-英文.webp'; // Path to your video poster image
