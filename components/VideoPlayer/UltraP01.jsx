...
const VideoPlayer = () => {
    const videoUrl = 'https://www.ultraehp.com/video/極安檢測%20介紹胃幽門螺旋桿菌由來-中文.mp4'; // Path to your local video file

    const posterUrl = 'https://www.ultraehp.com/images/UP100/極安簡測 介紹胃幽門螺旋桿菌由來.webp'; // Path to your video poster image
